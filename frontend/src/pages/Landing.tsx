    ...
    <div className="min-h-screen bg-surface-deep text-white selection:bg-emerald-500/30">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl">
            {[
              ...
              { num: '$0', label: 'To you per inquiry', sub: 'Only per booked job &mdash; results only' },
            ].map(function(v) {
              return (
      ...
      <section className="py-28 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: '\uD83D\uDD12', title: 'Exclusive leads &mdash; zero competition', desc: "One contractor per trade per metro. No shared leads. No bidding wars. When a lead comes in, it&apos;s yours &mdash; booked and confirmed." },
              ...
              return (
                <div key={v.title} className="bg-surface border border-accent/15 rounded-xl p-8 transition-all duration-300 hover:-translate-y-[3px] hover:border-accent/30 hover:shadow-lg hover:shadow-accent/[0.05]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-4">
              {[
                { num: '100%', label: 'Exclusive leads &mdash; zero competition' },
                { num: '24/7', label: 'Autonomous lead capture &mdash; no missed calls' },
      ...
      <section id="pricing" className="relative py-28 px-6 border-y border-white/5 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-xs text-muted text-center mt-8 max-w-lg mx-auto">All plans include territory exclusivity, autonomous intake agents, and full booking integration. No hidden fees.</p>
        </div>
      </section>
